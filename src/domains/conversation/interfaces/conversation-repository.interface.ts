...
export interface IConversationRepository {
  create(data: { type: 'direct' | 'group'; name?: string; avatar_url?: string; created_by: string }): Promise<Conversation>;
  ...
  addParticipant(data: { conversation_id: string; user_id: string; role?: 'owner' | 'admin' | 'member' }): Promise<void>;
